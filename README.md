...
<table width="100%">
  <tr>
    <td width="33%" valign="top">
      ...
      <ul>
        <li><b>Lock-Free Ring Buffer</b> sub-microsecond HFT order queue</li>
        <li><b>L2 Order Book</b> price-time priority Go matching engine</li>
        <li><b>VWAP & TWAP</b> institutional algorithmic execution slicer</li>
        <li><b>Black-Scholes Options</b> Greeks & Monte Carlo 95% VaR</li>
      </ul>
      <p align="center">
        <a href="https://yaya2127.github.io/finpulse-trading-engine/"><b>🌐 Live App</b></a> | 
    ...
    <td width="33%" valign="top">
      ...
      <p><b>Distributed Industrial IoT Edge Platform</b></p>
      <ul>
        <li><b>Go 1.22</b> high-throughput telemetry ingestion & REST</li>
        <li><b>WebSockets</b> real-time metric broadcasting & Redis</li>
        <li><b>3D WebGL Three.js</b> turbine Digital Twin & Oscilloscope</li>
    ...
    <td width="33%" valign="top">
      ...
      <ul>
        <li><b>AST Parser</b> detecting SQLi, Secrets, BOF & Panics</li>
        <li><b>Agentic AI Reasoner</b> 1-click Git diff patch generator</li>
        <li><b>OWASP & ISO 27001</b> 6-axis security radar chart</li>
        <li><b>1-Click PDF Audit</b> Certificate Exporter & Studio UI</li>
      </ul>
      <p align="center">
