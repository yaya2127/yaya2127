...
- 🎓 **Senior Student**: 5th-Year Computer Engineering undergraduate at **Addis Ababa Science and Technology University (AASTU)**.
- 💡 **Passion & Mindset**: Driven by building high-performance software, cloud-native microservices, interactive web apps, and AI security systems.
- 🛠️ **Engineering Experience**: Strong foundation in computer architecture, operating systems, data structures, low-level firmware, and full-stack web applications.
- 🎯 **Career Goal**: Seeking **Computer Engineering & Software Engineering Internship** opportunities to solve real-world problems and collaborate with exceptional technical teams.
...
<img src="https://skillicons.dev/icons?i=go,py,cpp,c,ts,js,html,css,react,nextjs,threejs,flutter,tailwind,express,nodejs,postgres,mongodb,redis,docker,kubernetes,git,linux,postman,figma" />
...
<a href="https://t.me/Papaya_weekend27">
